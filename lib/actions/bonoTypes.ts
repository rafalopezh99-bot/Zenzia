...
// (horas o clases, a elegir) + precio. Es lo que aparece para elegir en
// "Bono" al dar de alta un alumno (ver lib/actions/contacts.ts) y en el
// desplegable de /bonos. No lleva alumno: eso se asocia después, al dar de
// alta o desde la ficha del alumno.
